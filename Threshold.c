...
void ImgErosion_Grey(unsigned char * imgBufIn,unsigned char * imgBufOut,int imgWidth,
							 int imgHeight) 
{
    int i=0,j=0;
...
void ImgDilation_Grey(unsigned char * imgBufIn,unsigned char * imgBufOut,int imgWidth,
							 int imgHeight) 
{
    int i=0,j=0;
...
void ImgDilation_Bin(unsigned char * imgBufIn,unsigned char * imgBufOut,int imgWidth,
							 int imgHeight) 
{
    int i=0,j=0,s=0,t=0;
    char value = 0;
...
void Open()
{
   ...
   ImgErosion_Grey(imgBufDstZone, buf,m_imgWidth,m_imgHeight);//先腐蚀

   ImgDilation_Grey(buf, imgBufSrcZone,m_imgWidth,m_imgHeight);//后膨胀
...
void Close()
{
	...
	//先膨胀
	ImgDilation_Grey(imgBufSrc, buf,m_imgWidth,m_imgHeight);

	//后腐蚀
	ImgErosion_Grey(buf, imgBufDstZone,m_imgWidth,m_imgHeight);
